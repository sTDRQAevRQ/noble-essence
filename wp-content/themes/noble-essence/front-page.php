...
<div class="ne-mobile-menu">
  ...
  <nav class="ne-mobile-nav">
    ...
    <a href="<?php echo home_url('/categorie/parfums-orientaux-epices/'); ?>">Parfums orientaux</a>
    <a href="<?php echo home_url('/categorie/parfums-citruses-floraux/'); ?>">Parfums citruses</a>
    <a href="<?php echo home_url('/categorie/parfums-chauds-resineux/'); ?>">Parfums chauds</a>
  ...
  <div class="ne-products-grid">
    ...
    <article class="ne-product-card ne-fade-in">
      <a href="<?php the_permalink();?>">
        <?php if(has_post_thumbnail()):the_post_thumbnail('large',['class'=>'ne-product-card-img','alt'=>get_the_title().' — extrait de parfum niche — Noble Essence','loading'=>'lazy']);
        else:?><div class="ne-product-card-img" style="background:#1a1a1a;min-height:300px;"></div><?php endif;?>
      </a>
      <div class="ne-product-card-body">
        ...
        <a href="<?php the_permalink();?>" class="ne-btn-text">Découvrir <?php the_title();?> →</a>
        <?php if($cat):?><br><a href="<?php echo $cat_link;?>" class="ne-btn-text" style="font-size:12px;margin-top:8px;display:inline-block;">Voir tous nos <?php echo strtolower($cat[0]->name);?> →</a><?php endif;?>
      </div>
    </article>
...
<section class="ne-univers">
  ...
  <div class="ne-univers-content ne-fade-in">
    ...
    <p>Un <a href="<?php echo home_url('/blog/extrait-de-parfum-guide/');?>">extrait de parfum</a> concentre l'essentiel. Vingt pour cent de matières. Un sillage qui traverse les heures.</p>
    ...
    <p>Noble Essence refuse le parfum standardisé. Trois créations. Des caractères affirmés.</p>
    <div class="ne-univers-cta"><a href="<?php echo home_url('/la-maison/');?>" class="ne-btn-text">La philosophie de la maison →</a></div>
  </div>
</section>
...
<section class="ne-section ne-section--alt">
  ...
  <div class="ne-blog-grid">
    ...
    <article class="ne-blog-article ne-fade-in">
      ...
      <div class="ne-blog-article-body">
        <?php $cats=get_the_category();if($cats):?><a href="<?php echo get_category_link($cats[0]->term_id);?>" class="label-or"><?php echo $cats[0]->name;?></a><?php endif;?>
        <h3><a href="<?php the_permalink();?>"><?php the_title();?></a></h3>
    ...
    <div class="ne-blog-secondary">
      ...
      <article class="ne-blog-article ne-blog-article-small ne-fade-in">
        ...
        <div>
          <?php $cats=get_the_category();if($cats):?><a href="<?php echo get_category_link($cats[0]->term_id);?>" class="label-or" style="font-size:10px;"><?php echo $cats[0]->name;?></a><?php endif;?>
  ...
  <div class="ne-blog-cta ne-fade-in"><a href="<?php echo home_url('/blog/');?>" class="ne-btn-text">Voir tous les articles →</a></div>
</section>
<?php endif;?>
